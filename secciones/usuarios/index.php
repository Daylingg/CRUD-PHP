<?php
    ...
    $sentencia=$conexion -> prepare("SELECT * FROM `tbl_usuarios`");//prepara la coneccion para q seleccione lo q hay en usuarios
    $sentencia->execute();//ejecuta la sentencia
    $lista_tabla_usuarios=$sentencia->fetchAll(PDO::FETCH_ASSOC);//guarda los resultados en un array
